...
from carla_env.server.carla_agents.navigation.behavior_types import (
    Aggressive,
    Cautious,
    Normal,
)
from carla_env.server.carla_agents.navigation.local_planner import RoadOption
from carla_env.server.carla_agents.tools.misc import (
    compute_distance,
    get_speed,
    is_within_distance,
    positive,
...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(
        self, vehicle, behavior="normal", opt_dict=None, map_inst=None, grp_inst=None
    ):
        """
        Constructor method.
